...
(let ((brown-1 "#452E2E") (brown-2 "#865C38") (brown-3 "#4B3330")
  ...
  (custom-theme-set-faces
   ...
   '(term-color-black ((t (:foreground "#1F1611"))))
   '(term-color-blue ((t (:foreground "cornflower blue"))))
   '(term-color-cyan ((t (:foreground "aquamarine3"))))
   '(term-color-green ((t (:foreground "OliveDrab4"))))
   '(term-color-magenta ((t (:foreground "maroon3"))))
   '(term-color-red ((t (:foreground "#990000"))))
   '(term-color-white ((t (:foreground "#E6E1DC"))))
   '(term-color-yellow ((t (:foreground "#EFAC32")))))
  (custom-theme-set-variables
   'xtof-birds
