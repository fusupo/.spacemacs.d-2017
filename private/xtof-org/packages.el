...
(defun xtof-org/pre-init-org ()
  (spacemacs|use-package-add-hook org
    ...
    :post-config (progn
                   ...
                   (load-file "~/.spacemacs.d/private/xtof-org/src/setup-org-habits.el")
                   (xtof/org-habit-setup)
                   ;; (xtof/org-capture-setup)

                   ;; (eval-after-load "spacemacs"
                   ;;   (progn
                       (print "EVAL AFTER LOAD")
                       ;;  ORG DIRECTORY
                     ...
                     ;;   )
                     ;; )
                   (load-file "~/.spacemacs.d/private/xtof-org/src/setup-org-capture-tpls.el")
                   )
    )
  )
